...
class SCC():
    ...
    def __init__(self,graf=0,lang=0,dias=0,casas=1000):
        self.graf = graf        
        self.casas = casas
    ...
    def SHC_config(self,casa_id):
        ...
        # Extração de gráficos especifícos
        # lst_cargas = 1        
        # alfa = 0.25
        # tarifa = 1
        # conf_fz = 1 
