...
class ExecPSO:
    ...
    * Aplica parâmetros iniciais ao PSO se não declarados :
    ...
    def __init__(self,c1=2,c2=2,
        ...
        self.dados_fz = ModConfFz.Fz_sim().Fuzificar(user_var[0],user_var[1],user_var[2])  # Gera valores t,u,h,w      
    ...
    def PSO(self):
        ...
        self.lst = [f'{np.min(gbest):.3}',
                    ...
                    f'{np.max(Conforto):.5}',                                        
                    f'{np.mean(tempo):.5}',
                    f'{self.dados_fz[0]}',  # temp     
                    f'{self.dados_fz[1]}',  # umid                   
                    f'{self.dados_fz[2]}',  # humor 
                    f'{self.dados_fz[3]}',  # omega
                    ]
